    ...
    <div className="relative bg-formidable-dark min-h-screen">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                key={index}
                className="bg-formidable-dark/10 backdrop-blur-sm p-8 rounded-lg"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            {[
              ...
              <motion.div
                key={index}
                className="text-center p-8 bg-formidable-gold/5 rounded-lg border border-formidable-gold/20"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-formidable-gold mb-8" style={{ fontSize: '32px' }}>
                Formación
              </h3>
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="border-l-2 border-formidable-gold/30 pl-6 py-2">
      ...
      <section className="relative py-20 px-6 bg-formidable-gold">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              className="text-formidable-dark"
