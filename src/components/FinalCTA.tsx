    ...
    <section id="contacto" className="py-24 px-6 md:px-24 bg-formidable-olive">
      ...
      >
        ...
        <Button 
          ...
          asChild
        >
          <a href="https://cal.com/mario-acevedo-aguilar-biepq1/conversacion-formidable-1h" target="_blank" rel="noopener noreferrer" className="whitespace-normal md:whitespace-nowrap">
